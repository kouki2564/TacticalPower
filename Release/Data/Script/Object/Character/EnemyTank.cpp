...
EnemyTank::EnemyTank()
{
	EffectManager::Instance().RegisterEffect("HitT", LoadEffekseerEffect("Data/Effect/Hit.efkefc", 10.0f), VGet(0, 0, 0), VGet(0, 0, 0));
}
...
void EnemyTank::Init(std::string name, int& handle, VECTOR pos, VECTOR dir)
{
...
bool EnemyTank::SetDamagePoint(float damagePoint)
{
	// 防御値分の計算
